...
<div class="row">
        ...
        <form method="POST" action="{{ route( 'admin.workshops.update', $workshop->id ) }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control" id="description" rows="3">{{ $workshop->description }}</textarea>
                    @error('description')
                            <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="category_id" class="form-select form-select-sm mb-3" aria-label=".form-select-sm example">
                        ...
                        @if($category->id == $workshop->category->id)
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" {{ $workshop->status == 1 ? 'checked' : '' }} value="1" type="radio" name="status" id="status1">
                        <label class="form-check-label" for="status1">Active</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" {{ $workshop->status == 0 ? 'checked' : '' }} value="0" type="radio" name="status" id="status2">
    ...
    <div class="container">
      <a href="{{ route( 'admin.workshops.index' ) }}" class="btn btn-info ms-0 mt-3 col-12">Go back</a>
    </div>
</div>
@endsection
